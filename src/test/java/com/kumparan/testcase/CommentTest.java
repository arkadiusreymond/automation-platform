...
public class CommentTest extends TestInstrument {
    ...
    @Test
    public void commentViaThumbnailWithoutLogin() {
        ...
        kumparan.komentarPage().typeOnTulisKomentar("tulis tulis"+randomNum);
        ...
        kumparan.komentarPage().isOnKomentarPage();
        kumparan.komentarPage().validateCommentIsExist("tulis tulis"+randomNum);
    }

    @Test(priority = 1)
    public void commentViaThumbnaiLogin() {
        kumparan.forYouPage().checkFirstAppLoad();
        kumparan.forYouPage().clearCache();
        ...
        kumparan.loginPage().isOnLoginPage();
        kumparan.loginPage().login("nanmaidabunanmaidabu@gmail.com", "mantanqwerty");
        kumparan.loginPage().goToForYouTab();
        kumparan.forYouPage().isOnForYouPage();
        kumparan.forYouPage().tapOnCategoryTab("News");
        kumparan.categoryLandingPage().isOnCategoryLandingPage("News");
        kumparan.forYouPage().swipeToBottomPage();
        kumparan.forYouPage().tapOnButtonComment();
        kumparan.komentarPage().isOnKomentarPage();
        kumparan.komentarPage().typeOnTulisKomentar("tulis tulis"+randomNum);
        kumparan.komentarPage().tapOnSendButton();
        kumparan.komentarPage().delay(2000);
        kumparan.komentarPage().hideKeyboard();
        kumparan.komentarPage().isOnKomentarPage();
        kumparan.komentarPage().validateCommentIsExist("tulis tulis"+randomNum);
    }

    @Test(priority = 2)
    public void commentViaThumbnaiLoginLongComment() {
        kumparan.forYouPage().checkFirstAppLoad();
        kumparan.forYouPage().clearCache();
        kumparan.bottomBar().tapOnMenuBottomBar();
        kumparan.menuPage().tapOnLoginMenu();
    ...
    @Test(priority = 3)
    public void commentInNewsLogin() {
        kumparan.forYouPage().checkFirstAppLoad();
        kumparan.forYouPage().clearCache();
        kumparan.bottomBar().tapOnMenuBottomBar();
        kumparan.menuPage().tapOnLoginMenu();
    ...
    @Test(priority = 4)
    public void commentInNewslWithoutLogin() {
        kumparan.forYouPage().checkFirstAppLoad();
        kumparan.forYouPage().clearCache();
        kumparan.forYouPage().isOnForYouPage();
        kumparan.forYouPage().tapOnCategoryTab("Entertainment");
